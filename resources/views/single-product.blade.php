                    ...
                    <div class="single_book_thumb">
                        <div id="book_details_slider" class="carousel slide" data-ride="carousel">
                            <ol class="carousel-indicators">
                                ...
                                <li data-target="#book_details_slider" data-slide-to="1" style="background-image: url({{$book['image']}});">
                                </li>
                                <li data-target="#book_details_slider" data-slide-to="2" style="background-image: url({{$book['image']}});">
                                </li>
                                <li data-target="#book_details_slider" data-slide-to="3" style="background-image: url({{$book['image']}});">
                                </li>
                            </ol>
                            <div class="carousel-inner">
                                ...
                                <div class="carousel-item">
                                    <a class="gallery_img" href="{{$book['image']}}">
                                        <img class="d-block w-100" src="{{$book['image']}}" alt="Second slide">
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a class="gallery_img" href="{{$book['image']}}">
                                        <img class="d-block w-100" src="{{$book['image']}}" alt="Third slide">
                                    </a>
                                </div>
                                <div class="carousel-item">
                                    <a class="gallery_img" href="{{$book['image']}}">
                                        <img class="d-block w-100" src="{{$book['image']}}" alt="Fourth slide">
                                    </a>
                                </div>
                            </div>
                        </div>
