            ...
            <nav class="navbar bg-light navbar-light" id="navbar">
                ...
                <div class="navbar-nav w-100">
                 {{-- <a href="{{route('admin.index')}}" class="nav-item nav-link active"><i class="fas fa-calendar-check me-2"></i>Reservations</a> --}}
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"><i class="fas fa-users me-2"></i>Books</a>
                        <div class="dropdown-menu bg-transparent border-0">
                            <a href="{{route('admin.books')}}" class="nav-item nav-link">Show Books</a>
                ...
                <div class="bg-light rounded-top p-4">
                    <div class="row">
                        <div class="col-12 col-sm-6 text-center text-sm-start">
                            &copy; <a href="{{URL::to('/')}}">ShareBook</a>, All Right Reserved.
                        </div>
                    </div>
                </div>
            </div>
